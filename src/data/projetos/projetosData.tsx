...
export const projects: Project[] = [
  ...
  },
  {
    ...
    details: "Este projeto é uma aplicação de portal de transparência para a fundação FAPG. Seu objetivo era realizar uma aplicação intuitiva que atingesse todos os requisistos de administração do cliente.",
    contribution: 'Contribuição: No projeto na questão de desenvolvimento eu colabarei com o envio de email para o administrador quando o projeto for vencer e refatoração do código. Também contribuí com documentação do produto e a comunicação entre a equipe.',
  ...
  },
  {
    ...
    contribution: 'Contribuição: Neste projeto eu colaborei com o desenvolvimento backend da aplicação. Realizei funcionalidade como criação de Problema, validação de horário de técnico, organização de código.',
  ...
  },
  {
    ...
    contribution: 'Contribuição: Neste projeto eu colaborei com o desenvolvimento backend da aplicação. Realizei funcinalidades como, troca de senha, validação de usuario, criar conta, criar postagem do blog.',
